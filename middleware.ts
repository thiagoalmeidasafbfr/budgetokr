...
const DEPT_ALLOWED_PATHS = ['/dept', '/dre', '/analise', '/plano-contas', '/api/dept-dashboard', '/api/dept-medidas', '/api/analise', '/api/dre', '/api/kpis', '/api/kpis/valores', '/api/lancamentos', '/api/medidas', '/api/plano-contas', '/api/me', '/api/auth/logout', '/api/dimensoes']
