  ...
  return (
    <>
      ...
      <aside className={cn(
        ...
        style={{ backgroundColor: '#1A1820', borderColor: 'rgba(255,255,255,0.1)' }}
      >
              ...
              return (
                <div key={item.label}>
                  <div className={cn('flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-semibold cursor-default')}
                    style={{ color: anyActive ? '#be8c4a' : 'rgba(255,255,255,0.45)' }}
                  >
                    <Icon size={13} style={{ color: anyActive ? '#be8c4a' : 'rgba(255,255,255,0.4)' }} />
                      ...
                      return (
                        <Link key={child.href} href={child.href} onClick={closeMobile}
                          ...
                          style={{
                            ...
                            color: active ? '#be8c4a' : 'rgba(255,255,255,0.65)',
                          }}
                        >
                          {CIcon && <CIcon size={12} style={{ color: active ? '#be8c4a' : 'rgba(255,255,255,0.45)' }} />}
            ...
            return (
              <Link key={item.href} href={item.href} onClick={closeMobile}
                ...
                style={{
                  ...
                  color: active ? '#be8c4a' : 'rgba(255,255,255,0.7)',
                }}
              >
                ...
                >
                  <Icon size={14} style={{ color: active ? '#be8c4a' : 'rgba(255,255,255,0.45)' }} />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium leading-tight"
                    style={{ color: active ? '#be8c4a' : 'rgba(255,255,255,0.82)' }}
                  >
                    {item.label}
                  </p>
                  {item.sublabel && (
                    <p className="text-[11px] leading-tight mt-0.5 truncate"
                      style={{ color: active ? 'rgba(190,140,74,0.7)' : 'rgba(255,255,255,0.42)' }}
                    >
                      {item.sublabel}
                    </p>
                  )}
