      ...
      <Card>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading && <tr><td colSpan={6} className="text-center py-8 text-gray-400"><div className="w-5 h-5 border-2 border-indigo-400 border-t-transparent rounded-full animate-spin mx-auto" /></td></tr>}
              ...
              {!loading && rows.length === 0 && <tr><td colSpan={6} className="text-center py-8 text-gray-400 text-sm">Nenhum registro. Importe via <a href="/upload" className="text-indigo-500 underline">Upload</a> ou adicione manualmente.</td></tr>}
            </tbody>
          </table>
        </div>
      </Card>
